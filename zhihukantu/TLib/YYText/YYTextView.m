...
- (void)setCaretAlwaysVisable:(BOOL)caretAlwaysVisable {
    _caretAlwaysVisable = caretAlwaysVisable;
    [self _updateSelectionView];
}
...
- (void)_updateSelectionView {
    ...
    _selectionView.caretBlinks = self.editable && self.caretAlwaysVisable ? YES : NO;
    _selectionView.caretVisible = self.editable && self.caretAlwaysVisable ? YES : NO;
