...
#define  LSActionSheetBackgroundColor [UIColor colorWithRed:1/255.0 green:1/255.0 blue:1/255.0 alpha:0.3]
...
NSInteger LSDestructiveIndex = 39923234;
NSInteger LSCancelIndex = 69823233;
...
-(void)show
{
    ...
    UIVisualEffectView * btnContent = [[UIVisualEffectView alloc] initWithEffect:blurEffect];
    ...
    btnContent.frame = CGRectMake(0, topView.frame.origin.y, LSActionSheetScreenWidth, cancel.frame.origin.y + cancel.frame.size.height - topView.frame.origin.y);
