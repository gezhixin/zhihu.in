//
//  XSTQRCodeScanViewController.m
//  xiaoshutong
//
//  Created by 葛枝鑫 on 2017/11/7.
//  Copyright © 2017年 葛枝鑫. All rights reserved.
//

#import "XSTQRCodeScanViewController.h"
#import "SGQRCode.h"
#import "XSTNavigationViewController.h"
#import "AppDelegate.h"

@interface XSTQRCodeScanViewController () <SGQRCodeScanManagerDelegate, SGQRCodeAlbumManagerDelegate>
...
@implementation XSTQRCodeScanViewController

+ (instancetype)showWithViewController:(UIViewController *)viewController {
    XSTQRCodeScanViewController * vc = [[XSTQRCodeScanViewController alloc] init];
    XSTNavigationViewController * nvc = [[XSTNavigationViewController alloc] initWithRootViewController:vc];
...
- (void)setupNavigationBar {
    ...
    [self setRightNavigationItems:@[@"相册"] clicked:^(id sender, NSInteger index) {
        @strongify(self);
